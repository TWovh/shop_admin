...
# Минимальные URL'ы для тестирования
ROOT_URLCONF = 'shopadmin.test_urls'
...
DATABASES = {
    'default': {
        ...
        'NAME': ':memory:',  # Используем память для быстрых тестов
    }
}
...
NOVA_POSHTA_API_URL = 'http://test.novaposhta.ua/'
